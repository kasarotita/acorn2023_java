...
public class MainClass01 {
	public static void main(String[] args) {
		...
		//int type 5 개를 저장하고 있는 배열 객체를 생성해서 참조값을 nums 라는 지역변수에 담기
		int[] nums= {10, 20, 30, 40, 50};
		
		//int[] => 참조 , int => 기본
		//int [] type 객체 0 1 2 3 4 5 = 10 20 30 40 50
		//int [] type 변수 -> nums
		System.out.println(nums[0]);
		
		//double type 5개를 저장하고 있는 배열 객체 생성해서 참조값을 nums2 라는 지역변수에 담아보세요
		...
		//배열은 순서가 있는 데이터 이다. 특징 index 의 item 참조하는 방법
		int first=nums[0];
		int second=nums[1];
		int third=nums[2];
